...
def analyze_pcap(pcap_file):
    ...
    print(f"--- Part B Results for {pcap_file} ---")
...
def main():
    # Only analyze Part B PCAP files
    pcap_files = [f for f in os.listdir() if f.endswith("_part_b.pcap")]

    if not pcap_files:
        print("No Part B PCAP files found!")
        return
